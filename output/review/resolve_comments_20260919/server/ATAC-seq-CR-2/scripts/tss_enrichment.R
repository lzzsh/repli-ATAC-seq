...
setwd("/storage2/liuxiaodongLab/liaozizhuo/Projects/ATAC-seq-CR-2/tss_plot")
...
#file_list(Args[6])
files <- list.files('/storage2/liuxiaodongLab/liaozizhuo/Projects/ATAC-seq-CR-2/bwa_all_rawdata','*_q30.bam',full.names=T)
file_list(files)
