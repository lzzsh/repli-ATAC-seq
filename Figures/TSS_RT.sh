...
# IDR_peaks
bedtools intersect -a TSS.bed -b ZH11_RT_org.gff3 -wa -wb > TSS_RT_org.bed
cut -f 1,2,3,4,5,6,10 TSS_RT_org.bed > TSS_RT_temp.bed
mv TSS_RT_temp.bed TSS_RT_org.bed
